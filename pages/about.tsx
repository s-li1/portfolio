...
import { textVariants } from '../variants/variants';
...
export default function About() {
    return (
        <Container title="About - Steven Li" displayFooter={true}>
            <AnimatePresence>
                <motion.div className="flex-col text-main-black p-10 md:flex md: items-center" variants={textVariants} initial="exit" animate="enter" exit="exit">
                    <div className="mb-20 md:flex">
                        ...
                        <div className="h-full w-full md:max-w-md md:ml-10">
                            <AnimatedImage src={BITCohort} alt="Bachelor of Information Technology Cohort 2022"/>
                        </div>
                    </div>
                    <div className="mb-10 md:flex md:flex-row-reverse">
                        ...
                        <div className="h-full w-full md:max-w-md md:mr-10">
                            <AnimatedImage src={ACSS} alt="Australia Chinese Students Society"/>
                        </div>
                    </div>
                </motion.div>
            </AnimatePresence>
